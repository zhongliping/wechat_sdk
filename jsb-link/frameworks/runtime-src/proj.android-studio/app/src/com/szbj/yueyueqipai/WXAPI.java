...
//		request.sign= "7FFECB600D7157C5AA49810D2D8F28BC2811827B";
	...
	public static void Login(){
		Log.d("payargs", "java 收到微信登陆 请求");
		isLogin = true;
		isPay = false;
		final SendAuth.Req req = new SendAuth.Req();
		req.scope = "snsapi_userinfo";
		req.state = "carjob_wx_login";
		Log.d("payargs", "api" + api);
		api.sendReq(req);
	...
	public static void Share(String url,String title,String desc,String type){
		try{
			...
			Bitmap bmp = BitmapFactory.decodeResource(WXAPI.instance.getResources(),R.mipmap.ic_launcher);//R.drawable.icon
