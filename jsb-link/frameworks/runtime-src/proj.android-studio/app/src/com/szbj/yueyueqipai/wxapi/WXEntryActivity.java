package com.szbj.yueyueqipai.wxapi;
...
import com.szbj.yueyueqipai.Constants;
import com.szbj.yueyueqipai.WXAPI;
			...
			if(WXAPI.isLogin){
				...
				if(authResp != null && authResp.code != null){
					...
					Cocos2dxGLSurfaceView.getInstance().queueEvent(new Runnable() {
					    @Override
					    public void run() {
							Cocos2dxJavascriptJavaBridge.evalString("cc.vv.anysdkMgr.onLoginResp(\""+ code +"\",\""+ Constants.CHANNEL +"\")");//'"+ cc +"','"+Constants.CHANNEL+"'
					    }
					});
